...
print (" ")
print("Problem 3")
print("Because the sample size is so large for the owner, who is basically playing infinite games he is a steady state so it would need a confidence interval")
print (" ")
print("The average expected reward is:", SimulateOutcomes.get_ave_reward())
print("Based on 1000 simulations, the 95% confidence interval for the expexted reward is:",SimulateOutcomes.get_CI_Game_Rewards(0.05))
print (" ")
print("The average expected probability loss is:", SimulateOutcomes.get_probability_loss())
print("Based on 1000 simulations, the 95% confidence interval for the expexted reward is:",SimulateOutcomes.get_CI_Prob_Loss(0.05))